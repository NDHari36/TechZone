// Script để thêm các sản phẩm còn lại (đã thêm 3 thành công: ID 27, 28, 29)
// Hãy chạy script này sau khi thêm 3 sản phẩm đầu tiên thành công
...
const productsToAdd = [
  ...
  },
  {
    ...
    storage: "256GB",
    price: 17990000,
    description: "OnePlus 12 với Snapdragon 8 Gen 3, OxygenOS 14, camera 50MP + 48MP.",
    isActive: true,
    brandId: 1,
    categoryId: 1,
    stock: "13",
  ...
  },
  {
    ...
    storage: "512GB",
    price: 32990000,
    description: "Dell XPS 13 Plus với Intel Core Ultra, màn hình 13.4 inch OLED.",
    isActive: true,
    brandId: 1,
    categoryId: 2,
    stock: "12",
  ...
  },
  {
    ...
    storage: "512GB",
    price: 16990000,
    description: "ASUS Vivobook 15 với AMD Ryzen 7, màn hình 15.6 inch Full HD.",
    isActive: true,
    brandId: 1,
    categoryId: 2,
    stock: "14",
  ...
  },
  {
    ...
    storage: "256GB",
    price: 34990000,
    description: "Lenovo ThinkPad X1 Carbon Gen 12 - Laptop business nhẹ.",
    isActive: true,
    brandId: 1,
    categoryId: 2,
    stock: "10",
  ...
  },
  {
    ...
    storage: "512GB",
    price: 15990000,
    description: "HP Pavilion 15 với Intel Core i5, màn hình 15.6 inch.",
    isActive: true,
    brandId: 1,
    categoryId: 2,
    stock: "16",
  ...
  },
  {
    ...
    storage: "128GB",
    price: 15990000,
    description: "Samsung Galaxy Tab S9 với Snapdragon 8 Gen 2, màn hình 11 inch AMOLED.",
    isActive: true,
    brandId: 1,
    categoryId: 3,
    stock: "13",
  ...
  },
  {
    ...
    storage: "32GB",
    price: 12990000,
    description: "Apple Watch Ultra với màn hình LTPO OLED 49mm.",
    isActive: true,
    brandId: 1,
    categoryId: 1,
    stock: "7",
  ...
  },
  {
    ...
    storage: "N/A",
    price: 7990000,
    description: "Sony WH-1000XM5 - Tai nghe over-ear với ANC.",
    isActive: true,
    brandId: 1,
    categoryId: 1,
    stock: "11",
  ...
  },
  {
    ...
    storage: "N/A",
    price: 5990000,
    description: "Apple AirPods Pro - Tai nghe in-ear với ANC, Spatial Audio.",
    isActive: true,
    brandId: 1,
    categoryId: 1,
    stock: "18",
...
async function addAllProducts() {
  console.log('🚀 Thêm 16 sản phẩm còn lại...\n');
  ...
  console.log(`\n✅ Kết quả: ${successCount}/${productsToAdd.length} sản phẩm`);
}
